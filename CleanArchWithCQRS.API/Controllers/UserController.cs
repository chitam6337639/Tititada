...
using CleanArchWithCQRS.Application.User.Commands.CreateUser;
using CleanArchWithCQRS.Application.User.Commands.DeleteUser;
using CleanArchWithCQRS.Application.User.Commands.UpdateUser;
using CleanArchWithCQRS.Application.User.Queries.GetAllUsersDetailsQuery;
using CleanArchWithCQRS.Application.User.Queries.GetUserDetailsByUserNameQuery;
using CleanArchWithCQRS.Application.User.Queries.GetUserDetailsQuery;
using CleanArchWithCQRS.Application.User.Queries.GetUserQuery;
using MediatR;
